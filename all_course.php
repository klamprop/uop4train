...
function printTeaserSignUpCourses($connection){
 ...
 function printSMESECCourses($connection, $projectID){
  ...
  $query_select_courses .= " tbl_project_course.project_id = ".$projectID." AND tbl_courses.course_item_id = 1 AND tbl_courses.active = 1 AND tbl_courses.publish_to_anonymous = 1 ORDER BY tbl_courses.create_date DESC";
  ...
  function printCoursesPerCategory($connection, $course_category_id){
    ...
    $query_select_courses .= " tbl_match_course_category.course_category_id = ".$course_category_id." AND tbl_courses.course_item_id = 1 AND tbl_courses.active = 1 AND tbl_courses.publish_to_anonymous = 1 ORDER BY tbl_courses.create_date DESC";
    $result_select_courses = $connection->query($query_select_courses);
