<?php
	...
	include "access_role.php";
		...
		$query_select_category = "SELECT id, name, active FROM tbl_project ";
		...
		while($row = $result_select_category->fetch_row()){
			...
			$data_table_category.="<tr><td class=\"name\">".$row[1]."</td><td style=\"\" class=\"right\">";
			...
			$data_table_category.="<i class=\"fa fa-pencil\"></i></td><td style=\"\" class=\"right\"><i id=\"category".$row[0]."\" class=\"".$active_cat."\"></i></td></tr>";
			}
			$i_category++;
		}
