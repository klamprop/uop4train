  <?php
	...
	if(isset($_POST['int_part_id']) && isset($_POST['action']) && isset($_POST['course_id']) && $_POST['action']=="ins")
	{

			$query_insert = "INSERT INTO tbl_match_present_interact_course(course_id, presentation_id, interactive_id, order_list) VALUES (".$_POST['course_id'].",0,".$_POST['int_part_id'].",0)";			
